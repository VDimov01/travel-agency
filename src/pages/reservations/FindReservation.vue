...
const updateFoundReservation = async () => {
  try {
    const updatedReservation = {
      id: foundReservation.value._id,
      contactName: editForm.value.contactName,
      phoneNumber: editForm.value.phoneNumber,
      holiday: foundReservation.value.holiday._id,
    };
...
const deleteFoundReservation = async () => {
  try {
    await holidayStore.deleteReservation(foundReservation.value._id);
